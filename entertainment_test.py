...
fresh_tomatoes provided by UDACITY in order to generate HTML portions of project
...
star_wars_1 = movie.Movie("Star Wars : Episode I The Phantom Menace",
...
star_wars_2 = movie.Movie("Star Wars : Episode II Attack of the Clones",
...
star_wars_3 = movie.Movie("Star Wars : Episode III Revenge of the Sith",
...
star_wars_4 = movie.Movie("Star Wars : Episode IV A New Hope",
                        "Episode IV in the Star Wars Saga",
                        "https://upload.wikimedia.org/wikipedia/en/8/87/StarWarsMoviePoster1977.jpg",
                        "https://youtu.be/vZ734NWnAHA?list=PL3339D1C61DB4AB28",
                        "PG")

star_wars_5 = movie.Movie("Star Wars : Episode V The Empire Strikes Back",
...
star_wars_6 = movie.Movie("Star Wars : Episode VI Return of the Jedi",
...
star_wars_7 = movie.Movie("Star Wars : Episode VII The Force Awakens",
...
#add movies to array
movies =[star_wars_1,star_wars_2,star_wars_3,star_wars_4,star_wars_5,star_wars_6,star_wars_7]
