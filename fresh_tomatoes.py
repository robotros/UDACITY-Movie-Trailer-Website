...
Provided by UDACITY slightly modified

Generates and opens HTML for movie trailer website
using an array of movie objects

modifiedBy: Aron Roberts
Date: 6/4/2015
filename: fresh_tomatoes.py

Last Update: PEP8 Requirements
Some lines exceed the length requirement
...
<head>
 <meta charset="utf-8">
 <!--Modified TITLE-->
 <title>Star Wars Trailers</title>
      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <!--MODIFIED Nav Bar Label-->
            <a class="navbar-brand" href="#">Star Wars Movie Trailers</a>
          </div>
        </div>
      </div>
    </div>
...
<div class="col-md-6 col-lg-4 movie-tile text-center"
    ...
    <h2>{movie_title}</h2>
    <p> Rating : {rating} </br> {storyline}</p>
</div>
'''
...
def open_movies_page(movies):
    ...
    # Replace placeholder movie info with dynamically generated content
